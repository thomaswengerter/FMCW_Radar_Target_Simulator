...
for meas = 1:Szenarios
    ...
    parfor tidx = 1:floor(duration/tstep)
        %% Move Targets
        t = timesteps(tidx);
        [MovedTargets, Label] = move_TrajectoryPlanner(Traj, t/tstep+1, Targets, egoMotion);
        ...
        for i= 1:sz(1)
            ...
            [sbTarget, obstruction(i)] = modelSignal(Target, targetID, map, fmcw);
